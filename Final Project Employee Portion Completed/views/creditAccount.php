...
<?php 
     ...
     /*require_once('productModel.php');*/
      ...
      if(isset($_REQUEST['search']))
      {
            ...
            $search=getCreditAccById($cardnumber);
            ...
            <tr height="350px">
             ...
             <br><table border="1" >
                  ...
                  <br>
                        ...
                        <legend><b><u>All Credit Card Accounts</u></b></legend>
                         <br>
                  ...
                  <?php   for($i=0;$i<sizeof($datalist);$i++)         {     ?>
                        ...
                        <td><?= $datalist[$i]['creditbalance'] ?></td>
                        <td><?= $datalist[$i]['accounttype'] ?></td>
                        <td><?= $datalist[$i]['state'] ?></td>
                        <td>
                              <br>
                              <button><a href=<?php echo "../views/creditFreeze.php?cardnumber=".$datalist[$i]['cardnumber'];  ?> >Freeze / Unfreeze</a></button><br>
 ...
 <?php } ?> 
      ...
      <script type="text/javascript">
        ...
        function ajaxid()
        {
           ...
           xhttp.open('POST', '../controller/debitsearchCheck.php', true);
        ...
        function buildTable(data)
        {
           ...
           for(let i=-1;i<data.length;i++)
           {
            ...
            let row=`<tr>
                       ...
                       <td>
                           <br>
                           <button><a href=../views/creditFreeze.php?cardnumber=${data[i].cardnumber}>Freeze / Unfreeze</a></button><br>
