...
<?php 
      ...
      $data= getCreditAccById($cardnumber);
...
<body>
      <form method="post" action="../controller/creditfreezeunfreezeCheck.php?cardnumber=<?= $cardnumber ?>" >
           <table border="1" width="80%" align="center">
            ...
            <tr height="350px">
                  ...
                  <table border="1" align="center">
                        <tr height="50px" >
                              <td width="200px" align="center"><a href="creditAccount.php">Back</a></td>
                        </tr>
                  ...
                  <table  align="center" height="100%" width="100%" >
                        ...
                        <tr >
                              ...
                              <b> Debit Card Balance :   </b><input type="text" name="balance" value="<?= $creditbalance ?>" disabled><br><br>
                              <b> Status :   </b><input type="text" name="state" value="<?= $state ?>" disabled><br><br>
                              <b> Reason :   </b><input type="text" id="reason" name="reason" value="<?= $reason ?>" placeholder="Specify Reason" ><br>
